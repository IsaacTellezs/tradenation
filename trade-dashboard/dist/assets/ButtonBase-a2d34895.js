...
`),m.rippleVisible,dt,re,({theme:e})=>e.transitions.easing.easeInOut,m.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,m.child,m.childLeaving,ht,re,({theme:e})=>e.transitions.easing.easeInOut,m.childPulsate,mt,({theme:e})=>e.transitions.easing.easeInOut),yt=i.forwardRef(function(t,r){const u=Te({props:t,name:"MuiTouchRipple"}),{center:n=!1,classes:o={},className:s}=u,c=oe(u,pt),[l,p]=i.useState([]),d=i.useRef(0),g=i.useRef(null);i.useEffect(()=>{g.current&&(g.current(),g.current=null)},[l]);const b=i.useRef(!1),V=i.useRef(null),h=i.useRef(null),y=i.useRef(null);i.useEffect(()=>()=>{clearTimeout(V.current)},[]);const O=i.useCallback(f=>{const{pulsate:R,rippleX:E,rippleY:D,rippleSize:j,cb:U}=f;p(T=>[...T,$.jsx(gt,{classes:{ripple:x(o.ripple,m.ripple),rippleVisible:x(o.rippleVisible,m.rippleVisible),ripplePulsate:x(o.ripplePulsate,m.ripplePulsate),child:x(o.child,m.child),childLeaving:x(o.childLeaving,m.childLeaving),childPulsate:x(o.childPulsate,m.childPulsate)},timeout:re,pulsate:R,rippleX:E,rippleY:D,rippleSize:j},d.current)]),d.current+=1,g.current=U},[o]),N=i.useCallback((f={},R={},E=()=>{})=>{const{pulsate:D=!1,center:j=n||R.pulsate,fakeElement:U=!1}=R;if((f==null?void 0:f.type)==="mousedown"&&b.current){b.current=!1;return}(f==null?void 0:f.type)==="touchstart"&&(b.current=!0);const T=U?null:y.current,P=T?T.getBoundingClientRect():{width:0,height:0,left:0,top:0};let C,B,L;if(j||f===void 0||f.clientX===0&&f.clientY===0||!f.clientX&&!f.touches)C=Math.round(P.width/2),B=Math.round(P.height/2);else{const{clientX:k,clientY:v}=f.touches&&f.touches.length>0?f.touches[0]:f;C=Math.round(k-P.left),B=Math.round(v-P.top)}if(j)L=Math.sqrt((2*P.width**2+P.height**2)/3),L%2===0&&(L+=1);else{const k=Math.max(Math.abs((T?T.clientWidth:0)-C),C)*2+2,v=Math.max(Math.abs((T?T.clientHeight:0)-B),B)*2+2;L=Math.sqrt(k**2+v**2)}f!=null&&f.touches?h.current===null&&(h.current=()=>{O({pulsate:D,rippleX:C,rippleY:B,rippleSize:L,cb:E})},V.current=setTimeout(()=>{h.current&&(h.current(),h.current=null)},ft)):O({pulsate:D,rippleX:C,rippleY:B,rippleSize:L,cb:E})},[n,O]),I=i.useCallback(()=>{N({},{pulsate:!0})},[N]),_=i.useCallback((f,R)=>{if(clearTimeout(V.current),(f==null?void 0:f.type)==="touchend"&&h.current){h.current(),h.current=null,V.current=setTimeout(()=>{_(f,R)});return}h.current=null,p(E=>E.length>0?E.slice(1):E),g.current=R},[]);return i.useImperativeHandle(r,()=>({pulsate:I,start:N,stop:_}),[I,N,_]),$.jsx(bt,X({className:x(m.root,o.root,s),ref:y},c,{children:$.jsx(ut,{component:null,exit:!0,children:l})}))}),Rt=yt;function Et(e){return ze("MuiButtonBase",e)}const Tt=Ee("MuiButtonBase",["root","disabled","focusVisible"]),Mt=Tt,xt=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],Ct=e=>{const{disabled:t,focusVisible:r,focusVisibleClassName:u,classes:n}=e,s=Ae({root:["root",t&&"disabled",r&&"focusVisible"]},Et,n);return r&&u&&(s.root+=` ${u}`),s},vt=se("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${Mt.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),wt=i.forwardRef(function(t,r){const u=Te({props:t,name:"MuiButtonBase"}),{action:n,centerRipple:o=!1,children:s,className:c,component:l="button",disabled:p=!1,disableRipple:d=!1,disableTouchRipple:g=!1,focusRipple:b=!1,LinkComponent:V="a",onBlur:h,onClick:y,onContextMenu:O,onDragLeave:N,onFocus:I,onFocusVisible:_,onKeyDown:f,onKeyUp:R,onMouseDown:E,onMouseLeave:D,onMouseUp:j,onTouchEnd:U,onTouchMove:T,onTouchStart:P,tabIndex:C=0,TouchRippleProps:B,touchRippleRef:L,type:k}=u,v=oe(u,xt),K=i.useRef(null),M=i.useRef(null),Me=de(M,L),{isFocusVisibleRef:le,onFocus:xe,onBlur:Ce,ref:ve}=et(),[F,Y]=i.useState(!1);p&&F&&Y(!1),i.useImperativeHandle(n,()=>({focusVisible:()=>{Y(!0),K.current.focus()}}),[]);const[Z,we]=i.useState(!1);i.useEffect(()=>{we(!0)},[]);const Ve=Z&&!d&&!p;i.useEffect(()=>{F&&b&&!d&&Z&&M.current.pulsate()},[d,b,F,Z]);function w(a,pe,Ke=g){return H(fe=>(pe&&pe(fe),!Ke&&M.current&&M.current[a](fe),!0))}const Pe=w("start",E),Be=w("stop",O),Le=w("stop",N),De=w("stop",j),ke=w("stop",a=>{F&&a.preventDefault(),D&&D(a)}),Fe=w("start",P),Se=w("stop",U),$e=w("stop",T),Ne=w("stop",a=>{Ce(a),le.current===!1&&Y(!1),h&&h(a)},!1),_e=H(a=>{K.current||(K.current=a.currentTarget),xe(a),le.current===!0&&(Y(!0),_&&_(a)),I&&I(a)}),J=()=>{const a=K.current;return l&&l!=="button"&&!(a.tagName==="A"&&a.href)},Q=i.useRef(!1),je=H(a=>{b&&!Q.current&&F&&M.current&&a.key===" "&&(Q.current=!0,M.current.stop(a,()=>{M.current.start(a)})),a.target===a.currentTarget&&J()&&a.key===" "&&a.preventDefault(),f&&f(a),a.target===a.currentTarget&&J()&&a.key==="Enter"&&!p&&(a.preventDefault(),y&&y(a))}),Oe=H(a=>{b&&a.key===" "&&M.current&&F&&!a.defaultPrevented&&(Q.current=!1,M.current.stop(a,()=>{M.current.pulsate(a)})),R&&R(a),y&&a.target===a.currentTarget&&J()&&a.key===" "&&!a.defaultPrevented&&y(a)});let W=l;W==="button"&&(v.href||v.to)&&(W=V);const z={};W==="button"?(z.type=k===void 0?"button":k,z.disabled=p):(!v.href&&!v.to&&(z.role="button"),p&&(z["aria-disabled"]=p));const Ie=de(r,ve,K),ce=X({},u,{centerRipple:o,component:l,disabled:p,disableRipple:d,disableTouchRipple:g,focusRipple:b,tabIndex:C,focusVisible:F}),Ue=Ct(ce);return $.jsxs(vt,X({as:W,className:x(Ue.root,c),ownerState:ce,onBlur:Ne,onClick:y,onContextMenu:Be,onFocus:_e,onKeyDown:je,onKeyUp:Oe,onMouseDown:Pe,onMouseLeave:ke,onMouseUp:De,onDragLeave:Le,onTouchEnd:Se,onTouchMove:$e,onTouchStart:Fe,ref:Ie,tabIndex:p?-1:C,type:k},z,v,{children:[s,Ve?$.jsx(Rt,X({ref:Me,center:o},B)):null]}))}),Bt=wt;export{Bt as B,me as T,tt as _,We as a,et as b,H as c,Xe as s,de as u};
